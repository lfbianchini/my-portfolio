export const projects = [
  ...
  },
  {
    ...
    description:
      "This full-stack application provides secure file storage and sharing capabilities using React, Node.js, and AWS S3. It features real-time upload progress, temporary URL file sharing, and user authentication with PostgreSQL, demonstrating proficiency in modern web development practices.",
    image: "./project-1.gif",
  ...
  },
  {
    ...
    subtitle: "Java, Maven, Selenium, Azure OCR",
    description:
      "This Java-based archival research tool for UC Berkeley's 'The Daily Californian' automates web scraping and PDF creation from historical newspaper archives. It integrates Azure Form Recognizer for OCR and keyword search functionality, significantly reducing manual research time.",
    image: "./project-4.gif",
